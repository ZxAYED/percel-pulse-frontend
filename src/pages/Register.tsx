...
import { MapPin, ShieldCheck, TrendingUp, Truck } from "lucide-react";
...
type RegisterForm = { name: string; email: string; password: string; role: "admin" | "agent" | "customer" };
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 lg:flex-row lg:py-16">
        ...
        <MotionCard className="relative w-full max-w-xl border border-[hsl(var(--border))] bg-white shadow-xl lg:w-1/2">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Register to book pickups, track parcels, and manage assignments.</p>
          </CardHeader>
          <CardContent>
